...
关于调度欺骗与驱动崩溃的记录  
# 即尝试通过降频与内存压力欺骗安卓调度器以提升旧机型帧率，最终因Vulkan驱动边界条件触发导致环境崩坏的实验记录。（不建议模仿，此实验可能会对设备产生不可逆的损害，尤其是老机型）
...
## 实测数据：性能监控图表对比（注意:录屏会造成不可避免的帧率下降）  
- 前期（未干预）缺少统计数据，但有测试视频，平均约为3.0左右  
- 中期1 (BSL光影，开始干预) ![中期性能监控](assets/screenshotsassets/详细中期1.jpg)  
  - FPS: 平均5.7，帧时间最大517ms，CPU大核波动剧烈。  
- 中期2: ![中期性能监控](assets/screenshotsassets/详细中期2.jpg)  
  - FPS: 平均8.2，帧时间最大573ms，CPU大核高频运行。  
- 后期 (混沌特调) : ![后期性能监控](assets/screenshotsassets/后期测试ultra预设不关反射.jpg)  
...
3. 后期驱动崩溃提示底层风险，异常红屏黑屏，手机触屏疑似出现问题，vulkan驱动异常，安全补丁在2025年之前的设备极有可能触发Linux 内核 DRM 子系统漏洞，CVE-2025-21479，CVE-2025-27038等漏洞，需谨慎使用此类优化。  
